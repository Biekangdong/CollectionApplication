package com.example.update.inner;
...
import com.example.update.outer.DownloadManager;
...
public class InnerUpdateActivity extends AppCompatActivity {
    private AlertDialog.Builder mDialog;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_inner_update);
        ...
        if(isForce.equals("1")&& !TextUtils.isEmpty(updateinfo)){//强制更新
            forceUpdate(InnerUpdateActivity.this,appName,downUrl,updateinfo);
        }else{//非强制更新
            //正常升级
            normalUpdate(InnerUpdateActivity.this,appName,downUrl,updateinfo);
        }
        //网络检查版本是否需要更新
...
//            @Override
//            public void onError() {
//                noneUpdate(InnerUpdateActivity.this);
//            }
//        });
    }
    /**
    ...
    private void forceUpdate(final Context context, final String appName, final String downUrl, final String updateinfo) {
        ...
        mDialog.setPositiveButton("立即更新", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                AppInnerDownLoder.downLoadApk(InnerUpdateActivity.this,downUrl,appName);
            }
